...
@author: setsu
@filename: trip_vpredictor_carla.py
@coding: utf-8
...
class TripVPredictorCarla(TripPredictorCarla):
    ...
    def __init__(self, ds_path, layer_name, box_type, window_size, model_param_file_path, plog_path, gpu_id):
        ...
        """
        super(TripVPredictorCarla, self).__init__(ds_path, layer_name, box_type, window_size, model_param_file_path, plog_path, gpu_id)
