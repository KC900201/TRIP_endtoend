...
@author: setsu
@filename: trip_predictor_carla.py
@coding: utf-8
...
import os
from risk_prediction.trip_dataset_carla import TripDatasetCarla
from risk_prediction.trip_lstm import TripLSTM
from risk_prediction.trip_c_lstm import TripCLSTM

class TripPredictorCarla(object):
    """A class of TRIP(Traffic Risk Prediction) predictor
    """
    def __init__(self, ds_path, layer_name, box_type, window_size, model_param_file_path, plog_path, gpu_id):
        """ Constructor
            Args:
        ...
        """
        # set dataset
        self.ds = TripDatasetCarla(ds_path, layer_name, box_type)
        # check dataset
    ...
    def set_model(self, model_param_file_path):
        ...
        for line in lines:
            ...
            if param[0].strip() == 'model_path':
                npz_path =  line.split(':')[1].strip().split() 
