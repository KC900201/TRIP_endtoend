...
if __name__ == '__main__':
    ...
    model_arch = 'model_arch: MP-C-SPP-FC-LSTM\n'
    ...
    comparative_loss_margin = 'comparative_loss_margin: 0.5\n'
    ...
    optimizer_info = 'optimizer_info: adadelta'

    for i in range(1, 11):
        # Opening a a specific file, with intention to write
        paramFile = open('model_ebox_param' + str(i) + '.txt', 'w')
