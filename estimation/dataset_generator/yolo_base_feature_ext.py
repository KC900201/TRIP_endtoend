# -*- coding: utf-8 -*-
"""
Created on Wed Sep 11 20:07:36 2019
...
class YOLOBase(chainer.Chain):
    ...
    def predict(self, imgs):
        ...
        with chainer.using_config('train', False), \
            ...
            locs, objs, confs, features = self(self.xp.stack(x))
        locs = locs.array
        objs = objs.array
        confs = confs.array
        ...
        for loc, obj, conf, param in zip(locs, objs, confs, params):
            bbox, label, score, layer_id = self._decode(loc, obj, conf)
        ...
        return bboxes, labels, scores, layer_id, features
